...
app.layout = html.Div(
    [
        ...
        dbc.Tabs(
            [
                dbc.Tab(demografia1, label="Género"),
                dbc.Tab(demografia2, label="Edad"),
                dbc.Tab(demografia3, label="Estado civil"),
                dbc.Tab(demografia4, label="Nivel de puestos"),
                dbc.Tab(demografia5, label="Experiencia"),
            ]
        ),
        html.Br(), 
        ...
        dbc.Tabs(
            [
                ...
                dbc.Tab(cultura6, label="Gestión de alto desempeño"),
        ...
        dbc.Tabs(
            [
                dbc.Tab(salida1, label="Razón"),
                dbc.Tab(salida2, label="Tiempo traslado"),
                dbc.Tab(salida3, label="Medios de transporte"),
                dbc.Tab(salida4, label="Robo o asalto en transporte"),
                dbc.Tab(salida5, label="Acoso en transporte"),
                dbc.Tab(salida6, label="Robo total o parcial de vehículo"),
                ...
                dbc.Tab(salida11, label="Compañerismo"),
