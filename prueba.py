...
app.layout = html.Div(
    [
        ...
        dbc.Tabs(
            [
                dbc.Tab(demografia1, label="Género por territorio"),
                dbc.Tab(demografia2, label="Rango de edad de los encuestados"),
                dbc.Tab(demografia3, label="Estado civil"),
                dbc.Tab(demografia4, label="Nivel de puestos"),
                dbc.Tab(demografia5, label="Experiencia en su último puesto"),
            ]
        ),
        html.Br(), 
        ...
        dbc.Tabs(
            [
                dbc.Tab(antiguedad1, label="Tiempo en GS"),
                dbc.Tab(antiguedad2, label="Tiempo en su último puesto"),
            ]
        ),
        html.Br(),
        ...
        dbc.Tabs(
            [
                dbc.Tab(cultura1, label="Misión y visión en GS"),
                dbc.Tab(cultura2, label="Misión y visión de tu unidad de negocios"),
                dbc.Tab(cultura3, label="Código de ética"),
                dbc.Tab(cultura4, label="Valores y comportamiento"),
                dbc.Tab(cultura5, label="Prosperidad incluyente"),
                dbc.Tab(cultura6, label="Modelo de gestión de alto desempeño"),
                dbc.Tab(cultura7, label="Honestel"),
                dbc.Tab(cultura8, label="Ideas"),
                dbc.Tab(cultura9, label="Cuéntanos"),
            ]
        ),
        html.Br(),
        ...
        dbc.Tabs(
            [
                dbc.Tab(salida1, label="Razón por la cual concluyes en GS"),
                dbc.Tab(salida2, label="Tiempo promedio de casa a trabajo"),
                dbc.Tab(salida3, label="Medios de transporte que utilizam"),
                dbc.Tab(salida4, label="Robo o asalto en transporte público"),
                dbc.Tab(salida5, label="Acoso en transporte público"),
                dbc.Tab(salida6, label="robo total o parcial de vehículo propio"),
                dbc.Tab(salida7, label="Agresión física"),
                dbc.Tab(salida8, label="Extorsión"),
                dbc.Tab(salida9, label="Cómo encontraron su nuevo empleo"),
                dbc.Tab(salida10, label="Características que mejoraron"),
                dbc.Tab(salida11, label="Compañerismo en equipo de trabajo"),
                dbc.Tab(salida12, label="Pares cumplían su trabajo"),
                dbc.Tab(salida13, label="Honestidad"),
                dbc.Tab(salida14, label="Lealtad"),
                dbc.Tab(salida15, label="Confianza y respeto mutuo"),
                dbc.Tab(salida16, label="Pasión por el cliente"),
